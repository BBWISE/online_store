...
<body>
    ...
    <div>
        ...
        ?>
        <form id="login_section" action="backend/processor.php" method="post">
            
            <label for="name">
                Enter your full name:<br />
                <input id="regName" name="name" type="text" required placeholder="your full name..." />
            </label>
            <br />
            <label for="email">
                Email address:<br />
                <input id="regEmail" name="email" type="email" required placeholder="your email..." />
            </label>
            <br />
            <label for="password">
                Password:<br />

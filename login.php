...
<body>
    ...
    <div id="login_section">
        ...
        if(isset($_SESSION['LoginERROR'])){
            ?>
            <h3 id="loginError"><?php echo $_SESSION['LoginERROR'];?></h3>
            <?php
        }
            ?>
        <form id="foo" action="backend/processor.php" method="post">
            <label for="email">
                Email address:<br />
                <input id="loginEmail" name="email" type="email" required placeholder="your email..." />
            </label>
            <br />
            <label for="password">
                Password:<br />
            ...
            <br />
            <button id="buyButt" type="submit">Loging</button>
        </form>
        <form action="registration.php">
            To create a new Shoping account click on <button id="buyButt" type="submit">Sign up !</button>
        </form>
    </div>
